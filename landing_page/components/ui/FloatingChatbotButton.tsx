...
export function FloatingChatbotButton() {
  ...
  const handleClick = () => {
    ...
    console.log('AI Chatbot opened!')
    // Example: router.push('/ai-chatbot') or open modal
  }
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[9999] pointer-events-none">
      <div className="relative pointer-events-auto">
        ...
        {/* 24/7 Badge */}
        <motion.div
          className="absolute -top-1 -left-1 sm:-top-2 sm:-left-2 bg-gradient-to-r from-green-400 to-emerald-500 text-white text-xs font-bold px-1.5 py-0.5 sm:px-2 sm:py-1 rounded-full shadow-md"
