        ...
        <div className="relative bg-white/20 backdrop-blur-xl border border-white/30 rounded-3xl px-12 py-8 shadow-2xl hover:shadow-3xl transition-all duration-500">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              {/* CTA Button */}
              <a 
                href="https://bput4.tecosys.ai/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="group relative inline-block px-8 py-4 bg-gradient-to-r from-sky-600 to-blue-600 text-white rounded-2xl font-bold text-lg hover:from-sky-700 hover:to-blue-700 transform hover:scale-105 transition-all duration-300 shadow-xl hover:shadow-2xl animate-fadeIn" 
