...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50">
      ...
      {/* {mode && (
        <div className="absolute top-6 right-6 z-10">
          <div className="text-gray-600 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-lg shadow-sm">
            <span className="font-semibold text-blue-600 capitalize">{mode}</span> Mode
          </div>
        </div>
      )} */}
