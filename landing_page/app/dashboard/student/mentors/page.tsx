      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-lg max-w-3xl mx-auto">
            Experience the future of mentorship with our AI-powered career guidance system
          </p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          {/* AI Mentor Card */}
          <div className="group relative bg-white/70 backdrop-blur-xl border border-white/20 rounded-3xl p-8 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:-translate-y-2 overflow-hidden">
            {/* Animated Background */}
            ...
            <div className="absolute inset-0 overflow-hidden rounded-3xl pointer-events-none">
              ...
              <div className="absolute top-8 right-8 w-1 h-1 bg-purple-400 rounded-full animate-ping opacity-50" style={{ animationDelay: '0.5s' }}></div>
              <div className="absolute bottom-8 left-8 w-2 h-2 bg-green-400 rounded-full animate-ping opacity-60" style={{ animationDelay: '1s' }}></div>
              <div className="absolute bottom-4 right-4 w-1 h-1 bg-pink-400 rounded-full animate-ping opacity-50" style={{ animationDelay: '1.5s' }}></div>
            </div>

            <div className="relative z-10 text-center">
              {/* Animated AI Robot Head */}
              <div className="relative mb-6">
                <div className="w-24 h-24 bg-gradient-to-br from-blue-500 to-purple-600 rounded-3xl flex items-center justify-center mx-auto shadow-2xl group-hover:scale-110 transition-transform duration-500">
                  <div className="text-4xl animate-bounce">🤖</div>
                </div>
                {/* Rotating Ring */}
                <div className="absolute inset-0 w-24 h-24 mx-auto">
                  <div className="w-full h-full border-4 border-blue-300 rounded-full animate-spin opacity-30" style={{ animationDuration: '3s' }}></div>
                </div>
                {/* Pulsing Outer Ring */}
                <div className="absolute inset-0 w-24 h-24 mx-auto">
                  <div className="w-full h-full border-2 border-purple-300 rounded-full animate-ping opacity-20"></div>
                </div>
              </div>

              <h3 className="text-2xl font-bold text-gray-800 mb-3">AI Career Mentor</h3>
              <p className="text-gray-600 mb-6 leading-relaxed">
                24/7 AI-powered career guidance with personalized recommendations and instant responses
              </p>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="bg-white/40 backdrop-blur-sm rounded-2xl p-4 border border-white/30">
                  ...
                  <div className="text-sm font-medium text-gray-700">Instant Responses</div>
                </div>
                <div className="bg-white/40 backdrop-blur-sm rounded-2xl p-4 border border-white/30">
                  <div className="text-2xl mb-2">🎯</div>
                  <div className="text-sm font-medium text-gray-700">Personalized Advice</div>
                </div>
                <div className="bg-white/40 backdrop-blur-sm rounded-2xl p-4 border border-white/30">
                  <div className="text-2xl mb-2">📊</div>
                  <div className="text-sm font-medium text-gray-700">Career Analytics</div>
                </div>
                <div className="bg-white/40 backdrop-blur-sm rounded-2xl p-4 border border-white/30">
                  <div className="text-2xl mb-2">🚀</div>
                  <div className="text-sm font-medium text-gray-700">Growth Tracking</div>
                </div>
              </div>

              {/* Pricing */}
              <div className="bg-gradient-to-r from-green-100 to-emerald-100 rounded-2xl p-4 mb-6 border border-green-200">
                <div className="text-2xl font-bold text-green-700">₹200/session</div>
                <div className="text-sm text-green-600">Most Affordable AI Mentorship</div>
              </div>

              <button className="w-full py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-2xl font-bold hover:opacity-90 transform hover:scale-105 transition-all duration-300 shadow-xl">
                Start AI Session ✨
              </button>
            </div>
          </div>
          ...
          <div className="space-y-6">
            {/* Smart Matching */}
            <div className="group bg-white/70 backdrop-blur-xl border border-white/20 rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
              <div className="flex items-center space-x-4">
                <div className="w-16 h-16 bg-gradient-to-br from-pink-500 to-rose-600 rounded-2xl flex items-center justify-center text-2xl group-hover:scale-110 transition-transform duration-300 animate-pulse">
                  🎯
                </div>
                <div>
                  <h4 className="text-lg font-bold text-gray-800 mb-1">Smart Mentor Matching</h4>
                  <p className="text-gray-600 text-sm">AI analyzes your profile to find perfect mentor matches</p>
                </div>
              </div>
            </div>
            ...
            <div className="group bg-white/70 backdrop-blur-xl border border-white/20 rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
              <div className="flex items-center space-x-4">
                <div className="w-16 h-16 bg-gradient-to-br from-green-500 to-teal-600 rounded-2xl flex items-center justify-center text-2xl group-hover:scale-110 transition-transform duration-300 animate-bounce">
                  📊
                </div>
                <div>
                  <h4 className="text-lg font-bold text-gray-800 mb-1">Progress Analytics</h4>
                  <p className="text-gray-600 text-sm">Track your career growth with AI-powered insights</p>
                </div>
              </div>
            </div>
            ...
            <div className="group bg-white/70 backdrop-blur-xl border border-white/20 rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
              <div className="flex items-center space-x-4">
                <div className="w-16 h-16 bg-gradient-to-br from-orange-500 to-red-600 rounded-2xl flex items-center justify-center text-2xl group-hover:scale-110 transition-transform duration-300 animate-pulse">
                  🗺️
                </div>
                <div>
                  <h4 className="text-lg font-bold text-gray-800 mb-1">Custom Career Roadmap</h4>
                  <p className="text-gray-600 text-sm">Get personalized career paths based on your goals</p>
                </div>
              </div>
            </div>
            ...
            <div className="group bg-white/70 backdrop-blur-xl border border-white/20 rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
              <div className="flex items-center space-x-4">
                <div className="w-16 h-16 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl flex items-center justify-center text-2xl group-hover:scale-110 transition-transform duration-300 animate-spin" style={{ animationDuration: '3s' }}>
                  🌟
                </div>
                <div>
                  <h4 className="text-lg font-bold text-gray-800 mb-1">24/7 Availability</h4>
                  <p className="text-gray-600 text-sm">Get career guidance anytime, anywhere</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-600 rounded-3xl p-8 text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h3 className="text-3xl font-bold text-center mb-8">AI Mentor vs Traditional Mentoring</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 border border-white/30">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <h4 className="text-xl font-bold">AI Mentor</h4>
                </div>
              ...
              <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 border border-white/30">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <h4 className="text-xl font-bold">Human Mentor</h4>
                </div>
                <ul className="space-y-3 text-sm">
                  <li className="flex items-center space-x-2">
                    <span className="text-green-400">✅</span>
                  ...
                  <li className="flex items-center space-x-2">
                    ...
                    <span>₹900 - ₹2000 per session</span>
                  </li>
                  <li className="flex items-center space-x-2">
                    <span className="text-yellow-400">⚠️</span>
